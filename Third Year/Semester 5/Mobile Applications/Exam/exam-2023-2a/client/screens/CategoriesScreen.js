...
const CategoriesScreen = () => {
    ...
    const loadCategories = async () => {
        ...
        try {
            const response = await axios.get('http://192.168.0.150:2302/categories');
        ...
        <View style={styles.container}>
            {isLoading ? (<ActivityIndicator size="large" color="#0000ff"/>
                ...
                <View style={styles.offlineContainer}>
                    ...
                    <Button title="Retry" onPress={loadCategories} color="#007AFF"/>
                </View>
            ) : (
                <>
                    <TouchableOpacity
                        style={[styles.easiestButton, isOffline && styles.disabledButton]}
                        onPress={() => navigation.navigate('EasiestTips')}
                        disabled={isOffline}
                    >
                    ...
                    <FlatList
                        ...
                        renderItem={({item}) => (
                            <TouchableOpacity
                                ...
                                onPress={() => navigation.navigate('TipsList', {category: item})}
                            >
