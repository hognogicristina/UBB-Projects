...
void UserService::repositoryType(const std::string &fileType) {
	...
	if (fileType == "CSV") {
		userFile = R"(C:\Users\hogno\Documents\Fukulta\C++\OOP\a14-913-Hognogi-Cristina\shoppingBasket.csv)";
		...
		userFile = R"(C:\Users\hogno\Documents\Fukulta\C++\OOP\a14-913-Hognogi-Cristina\shoppingBasket.html)";
