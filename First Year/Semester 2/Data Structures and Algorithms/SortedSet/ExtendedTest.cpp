...
void testIntersection() {
	...
	SortedSet sortedSet1(rGreater);

	assert(sortedSet1.size() == 0);
	assert(sortedSet1.isEmpty() == true);

	sortedSet1.add(1);
	sortedSet1.add(2);
	sortedSet1.add(3);

	assert(sortedSet1.size() == 3);
	SortedSet sortedSet2(rGreater);
	...
	assert(sortedSet1.size() == 3);
	assert(sortedSet1.isEmpty() == false);

	sortedSet1.intersection(sortedSet2);
	assert(sortedSet1.size() == 2);
}
