module.exports = (app) => {
    ...
    app.post('/owners/add', controllerOwner.createOwner)
    app.delete('/owners/delete/:id', controllerOwner.deleteOwner)
    app.put('/owners/update/:id', controllerOwner.updateOwner)
}