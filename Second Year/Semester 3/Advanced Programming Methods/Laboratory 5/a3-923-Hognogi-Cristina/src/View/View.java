...
public class View {
    ...
    private void runStatement(InterStatement statement) throws ExpEvalException, UtilitsException, StatExeExecption, IOException {
    ...
    private void runProgram1() throws UtilitsException, ExpEvalException, StatExeExecption, IOException {
    ...
    private void runProgram2() throws UtilitsException, ExpEvalException, StatExeExecption, IOException {
    ...
    private void runProgram3() throws UtilitsException, ExpEvalException, StatExeExecption, IOException {
