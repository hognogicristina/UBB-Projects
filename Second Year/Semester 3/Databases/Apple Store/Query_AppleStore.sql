...
-- i. 4 queries using ANY and ALL to introduce a subquery in the WHERE clause (2 queries per operator); rewrite 2 
-- of them with aggregation operators, and the other 2 with IN / [NOT] IN.
